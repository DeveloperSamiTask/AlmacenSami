   ...
   public  class BD_Cierre_Caja : BD_Conexion 
    {
        ...
        public void BD_registrar_Inicio_Caja(EN_CierreCaja cli)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Apertura_Caja", cli.AperturCaja);
        ...
        public void BD_registrar_Cierrede_Caja(EN_CierreCaja cli)
        {
            SqlConnection cn = new SqlConnection();
            try
            {
        ...
        public DataTable BD_Listar_Todas_CierreCajas()
        {
            SqlConnection cn = new SqlConnection();
            try
            {
                cn.ConnectionString = Conectar();
                SqlDataAdapter da = new SqlDataAdapter("Sp_Listar_CierreCaja", cn);
        ...
        public DataTable BD_Listar_Cierre_Caja_DelDia()
        {
            SqlConnection cn = new SqlConnection();
            try
            {
        ...
        public DataTable BD_cargar_Cierre_Caja_DelDia(DateTime dia)
        {
            SqlConnection cn = new SqlConnection();
            try
            {
                cn.ConnectionString = Conectar();
                SqlDataAdapter da = new SqlDataAdapter("Sp_Listar_CierreCaja_delDia", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@fechas", dia);
                DataTable dato = new DataTable();
                da.Fill(dato);
                return dato;
            }
        ...
        public DataTable BD_Listar_Cierre_Caja_DelMes(DateTime mes)
        {
            ...
            try
            {
                ...
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@fechas", mes);
                DataTable dato = new DataTable();
                da.Fill(dato);
                return dato;
            }
        ...
        public DataTable BD_Buscar_General_Cierrecajas(string valor)
        {
            SqlConnection cn = new SqlConnection();
            try
            {
                cn.ConnectionString = Conectar();
                SqlDataAdapter da = new SqlDataAdapter("Sp_Buscador_CierreCaja_xValor", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
