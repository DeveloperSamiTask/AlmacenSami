...
namespace Microsell_Lite.Usuario
{
    public partial class Frm_Roles : Form
    {
        ...
        private void Configurar_listview()
        {
            ...
            lis.Columns.Add("Nombre de Rol", 280, HorizontalAlignment.Center);//1          
        ...
        private void Llenar_Listview(DataTable data)
        {
            ...
            for (int i = 0; i < data.Rows.Count; i++)
            {
                ...
                ListViewItem list = new ListViewItem(dr["Id_Rol"].ToString());
        ...
        {
            RN_Roles obj = new RN_Roles();
            DataTable dato = new DataTable();

            dato = obj.RN_Cargar_Todas_Roles();
        ...
        private void btn_listo_Click(object sender, EventArgs e)
        {
            ...
            {
                //Nuevo
                obj.RN_Registrar_Roles(txt_nom.Text);
                pnl_add.Visible = false;
                Cargar_Todos_Distrito();
                txt_nom.Text = "";
                fil.Show();
            ...
            {
                //Editar
                obj.RN_Editar_Roles(Convert.ToInt32(txt_id.Text), txt_nom.Text);
                pnl_add.Visible = false;
                Cargar_Todos_Distrito();
                txt_nom.Text = "";
                editar = false;
        ...
        private void btn_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    RN_Roles obj = new RN_Roles();
                    obj.RN_Eliminar_Roles(Convert.ToInt32(txt_id.Text));
                    Cargar_Todos_Distrito();
