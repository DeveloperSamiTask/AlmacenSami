    ...
    class Utilitario
    {
        ...
        public int  Solo_Numeros(int TECLAS)
        {
            switch (TECLAS)
            {
                ...
                case 13:
                case 8:
                case 46: //codigo assci de punto
                case 44: //codigo ascci de coma

                    return TECLAS;
                default :

                    MessageBox.Show("No Ingresar Letra por favor","Advertencia de Validacion",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
