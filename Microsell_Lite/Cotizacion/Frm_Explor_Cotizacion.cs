...
namespace Microsell_Lite.Cotizacion
{
    public partial class Frm_Explor_Cotizacion : Form
    {
        ...
        private void Configurar_listview()
        {
            ...
            lis.Columns.Add("Nombre Cliente", 286, HorizontalAlignment.Center);//5           
            ...
            lis.Columns.Add("Almacenero", 110, HorizontalAlignment.Center);//5
        ...
        private void Cargar_Todas_Cotizaciones()
        {
            ...
            dato = obj.BD_Listar_Todos_Cotizaciones();
        ...
        private void Frm_Explor_Cotizacion_KeyDown(object sender, KeyEventArgs e)
        {
